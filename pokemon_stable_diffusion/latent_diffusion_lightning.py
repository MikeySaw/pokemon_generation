...
from ldm.utils import count_params, default, exists, instantiate_from_config, isimage, ismap, log_txt_as_img, mean_flat
from pokemon_stable_diffusion.ddpm_model import DiffusionWrapper, disabled_train, make_beta_schedule
...
class DDPM(pl.LightningModule):
    ...
    def forward(self, x, *args, **kwargs):
        "define a forward function which will be wrapped by lightning model"
    ...
    def shared_step(self, batch):
        """
        A normal pratice in lightning built models, we define shared step to use
        this function in both training and validation steps
        """
