...
from src.data.make_dataset import PokemonDataset, pokemon_huggingface  # noqa
...
def dataset_statistics():
    ...
    print("Train dataset: Pokemon")
    print(f"Number of images: {len(data['train'])}")
    print("\n")
    print("Test dataset: Pokemon")
    print(f"Number of images: {len(data['test'])}")
    print("\n")
    print("Validation dataset: Pokemon")
